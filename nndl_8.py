...
class IMDBDataset(Dataset):
    def __init__(self, examples, word2id_dict, max_seq_len):
    ...
    def __getitem__(self, idx):
        ...
        seq, label = self.convert_example_to_feature(example)
    ...
    def convert_example_to_feature(self, example):
        seq, label = example
        seq = [self.word2id_dict.get(word, self.word2id_dict['[UNK]']) for word in seq.split(" ")[:self.max_seq_len]]
